...
//        tabScrollView.cachedPageLimit = 3
        ...
        if let navigationBar = self.navigationController?.navigationBar {
            ...
            navigationBar.titleTextAttributes = NSDictionary(object: UIColor.white, forKey: NSAttributedString.Key.foregroundColor as NSCopying) as? [NSAttributedStringKey : AnyObject]
